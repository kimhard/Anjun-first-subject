	...
	<div class="container" id="container">
		<div class="form-container sign-up-container">
			<form action="JoinService" method = "post">
				...
				<table>
				<tr>
				<td><input type="text" maxlength="6" placeholder = "주민번호 앞자리" name ="rrn1"></td>
				<td>-</td>
				<td><input type="text" maxlength="7" placeholder = "주민번호 뒷자리" name = "rrn2"></td>
				</tr>
				</table>
				<button>회원가입</button>
			</form>
		...
		<div class="form-container sign-in-container">
			<form action="LoginService" method ="post">
				...
				<input type="text" placeholder="아이디" name="id" /> <input
					type="password" placeholder="패스워드" name="pw" /> <a href="#">비밀번호를
					잊어버리셨나요?</a>
		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-panel overlay-left">
					<h2>돌아오신걸 환영합니다!</h2>
					<p>당신의 정보를 입력해주시길 바랍니다.</p>
					<button class="ghost" id="signIn">Sign In</button>
				</div>
				<div class="overlay-panel overlay-right">
					<h1>안녕 친구들!</h1>
					<p>회원가입을 하고 우리들의 여정에 동참하세요!</p>
