...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ca54d6e7a228681985539226b15919d4&libraries=services"></script>
<script>
	...
	var lat = sessionStorage.getItem("userLat"); // 위도
	var lon = sessionStorage.getItem("userLng"); // 경도
